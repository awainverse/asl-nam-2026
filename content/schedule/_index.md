...
<table>
    ...
    <tbody>
        ...
        <tr>
			...
			<td colspan = 2> Matthew Harrison-Trainor <br> Tutorial <a href="harrisontrainor/asl_cst_part1.pdf">1</a>, <a href="harrisontrainor/asl_cst_part2.pdf">2</a> </td>
        ...
        <tr>
			...
			<td>Matthew Harrison-Trainor <br> <a href="harrisontrainor/asl_cst_part3.pdf">3</a></td>
		</tr>
        <tr>
...
| | Connor Lockhart | *Pseudoﬁniteness of the Farey graph and random tesselations.* | S-240b |
| | Tyler Markkanen | *Deciding the density of computable and c.e. sets.* | S-245a |
| 5:00 - 5:20 | Robert S. Lubarsky | *A possibly new proof of a possibly old theorem.* | S-240a |
|  | Devrim Pekmezci | *Local revised Ellis group conjecture.* | S-240b |
|  | Karthik Ravishankar | *Ahmad pairs and the local structure of the enumeration degrees.* | S-245a |
| 5:30 - 5:50 | Morenikeji Neri | *Extracting bounds from proofs involving ultraproducts.* | S-240a |
|  | Jacob Stern | *Divisible ordered abelian groups that are not weakly o-minimal.* | S-240b |
|  | Joey Veltri | *Eﬀective recurrence for computable measure-preserving transformations.* | S-245a |
...
| | Yuki Takahashi | *Dependent dividing and sub-additivity of burden.* | S-240b |
